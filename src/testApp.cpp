...
//****************************************************************************
// here's where we tell the program what to display, I decided, for clarity purpose while testing, to only draw the depth
// (the colour of the image slightly changes depending on how close or far the user is from the camera, this works even
// before the skeleton is tracked) and the skeletons (it says plural skeletons but the program is for now set to detect
//only 1 user). I left out the camera and the point cloud so for now i can focus only on how the skeleton recognition works,
//without being distracted from the association with camera image and point cloud.
//****************************************************************************
    ...
    for (int nID = 0; nID < numUsers; nID++){
		...
		// UNCOMMENTED THIS ONE RIGHT ERE //
